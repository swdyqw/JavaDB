...
import top.lzxu.javadb.backend.dm.dataItem.DataItemImpl;
...
import top.lzxu.javadb.backend.dm.page.PageX;
import top.lzxu.javadb.backend.dm.pageCache.PageCache;
import top.lzxu.javadb.backend.dm.pageIndex.PageIndex;
import top.lzxu.javadb.backend.dm.pageIndex.PageInfo;
...
public class DataManagerImpl extends AbstractCache<DataItem> implements DataManager {
    ...
    public long insert(long xid, byte[] data) throws Exception {
        ...
        try {
            ...
            byte[] log = top.lzxu.javadb.backend.dm.Recover.insertLog(xid, pg, raw);
            logger.log(log);
    ...
    public void logDataItem(long xid, DataItem di) {
        byte[] log = top.lzxu.javadb.backend.dm.Recover.updateLog(xid, di);
        logger.log(log);
    }
